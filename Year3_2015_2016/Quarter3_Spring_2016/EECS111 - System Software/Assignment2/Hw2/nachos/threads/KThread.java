...
public class KThread {
	...
	public static void finish() {
		...
		//added code
		if(joinQueue != null){
			if(joinQueue.nextThread() != null){
				joinQueue.nextThread().run();
			}
			//joinQueue.V();
		}
	...
	public void join() {
		...
		//added code
		System.out.println("Join has occurred");
	...
	public static void selfTest() {
		...
		//added code
		System.out.println("Self Test of KThread started");
		
		//new KThread(new PingTest(1)).setName("forked thread").fork();
		KThread k = new KThread(new PingTest(1));
				k.setName("forked thread").fork();
				k.join();
