	...
	<body>
		...
		if (request.getParameter("submit2") != null) {
			...
			try {
				...
				// get game titles
				Elements game_titles = doc.select("h3");
				//out.println(game_titles.get(0).html()+"<br><br>");
				...
				out.println("Average Playtime in One Day: "+String.format("%.2f",averageplaysession)+" hours/day<br>");
				...
				*/
				...
				"<table>"+
					...
					"</tr>"+
					"<tr>"+
						"<td colspan=\"2\">"+images.get(0).toString()+"</td>"+
					"</tr>"+
				"</table>"+
				"<br>"+
				"<table>"+
