...
int landmark_entrance_coordinates[100][2] = { { 0 } },
landmark_boundary_coordinates[100][4] = { { 0 } },
taxi_stand_coordinates[10][2] = { { 0 } },
size[2] = { 0 };

char ew_list[100][50] = { { 0 } },
ns_list[100][50] = { { 0 } },
landmark_names[100][100] = { { 0 } }; /* read map stuff */
